...
class ContentRespEntity extends BaseResponseEntity{
	...
	ContentRespEntity.fromJson(Map<String, dynamic> json) {
		data = json['data'] != null ? new ContentRespData.fromJson(json['data']) : null;
	}
...
class ContentRespData {
	...
	ContentRespData({this.newProductList, this.subjectList, this.homeFlashPromotion, this.hotProductList, this.brandList, this.advertiseList});

	ContentRespData.fromJson(Map<String, dynamic> json) {
		if (json['newProductList'] != null) {
			newProductList = new List<ContentRespDataNewproductlist>();(json['newProductList'] as List).forEach((v) { newProductList.add(new ContentRespDataNewproductlist.fromJson(v)); });
		}
		if (json['subjectList'] != null) {
			subjectList = new List<ContentRespDataSubjectlist>();(json['subjectList'] as List).forEach((v) { subjectList.add(new ContentRespDataSubjectlist.fromJson(v)); });
		}
		homeFlashPromotion = json['homeFlashPromotion'] != null ? new ContentRespDataHomeflashpromotion.fromJson(json['homeFlashPromotion']) : null;
		if (json['hotProductList'] != null) {
			hotProductList = new List<ContentRespDataHotproductlist>();(json['hotProductList'] as List).forEach((v) { hotProductList.add(new ContentRespDataHotproductlist.fromJson(v)); });
		}
		if (json['brandList'] != null) {
			brandList = new List<ContentRespDataBrandlist>();(json['brandList'] as List).forEach((v) { brandList.add(new ContentRespDataBrandlist.fromJson(v)); });
		}
		if (json['advertiseList'] != null) {
			advertiseList = new List<ContentRespDataAdvertiselist>();(json['advertiseList'] as List).forEach((v) { advertiseList.add(new ContentRespDataAdvertiselist.fromJson(v)); });
		}
	}
	...
	Map<String, dynamic> toJson() {
      ...
      data['newProductList'] =  this.newProductList.map((v) => v.toJson()).toList();
    }
      ...
      data['hotProductList'] =  this.hotProductList.map((v) => v.toJson()).toList();
    }
		if (this.brandList != null) {
      data['brandList'] =  this.brandList.map((v) => v.toJson()).toList();
    }
		if (this.advertiseList != null) {
      data['advertiseList'] =  this.advertiseList.map((v) => v.toJson()).toList();
    }
		return data;
	}
}
...
class ContentRespDataNewproductlist {
	...
	ContentRespDataNewproductlist({this.note, this.newStatus, this.originalPrice, this.keywords, this.productCategoryName, this.feightTemplateId, this.lowStock, this.description, this.pic, this.productCategoryId, this.recommandStatus, this.verifyStatus, this.subTitle, this.deleteStatus, this.price, this.usePointLimit, this.id, this.giftGrowth, this.stock, this.publishStatus, this.promotionType, this.brandName, this.productSn, this.albumPics, this.productAttributeCategoryId, this.weight, this.detailTitle, this.sort, this.giftPoint, this.promotionPerLimit, this.sale, this.unit, this.serviceIds, this.brandId, this.name, this.previewStatus});
...
class ContentRespDataSubjectlist {
	...
	ContentRespDataSubjectlist({this.createTime, this.collectCount, this.description, this.showStatus, this.id, this.pic, this.title, this.readCount, this.categoryName, this.categoryId, this.recommendStatus, this.commentCount});
...
class ContentRespDataHotproductlist {
	...
	ContentRespDataHotproductlist({this.note, this.newStatus, this.originalPrice, this.keywords, this.productCategoryName, this.feightTemplateId, this.lowStock, this.description, this.pic, this.productCategoryId, this.recommandStatus, this.verifyStatus, this.subTitle, this.deleteStatus, this.price, this.usePointLimit, this.id, this.giftGrowth, this.stock, this.publishStatus, this.promotionType, this.brandName, this.productSn, this.albumPics, this.productAttributeCategoryId, this.weight, this.detailTitle, this.sort, this.giftPoint, this.promotionPerLimit, this.sale, this.unit, this.serviceIds, this.brandId, this.name, this.previewStatus});
...
class ContentRespDataBrandlist {
	...
	ContentRespDataBrandlist({this.productCommentCount, this.name, this.bigPic, this.logo, this.showStatus, this.id, this.sort, this.productCount, this.firstLetter, this.factoryStatus});
...
class ContentRespDataAdvertiselist {
	...
	ContentRespDataAdvertiselist({this.note, this.clickCount, this.name, this.orderCount, this.startTime, this.id, this.pic, this.endTime, this.sort, this.type, this.url, this.status});
