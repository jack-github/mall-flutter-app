...
class BaseResponseEntity2<T> {
  ...
  BaseResponseEntity2({this.status, this.msg, this.resCode,this.result,this.requestUrl});

  BaseResponseEntity2.fromJson(Map<String, dynamic> json) {
